...
setwd("C:\\Users\\p00185232\\OneDrive - Houston Independent School District\\Documents\\capping tool\\Downloads")

### read in file. I had to rename the file after download, it wouldn't import
### with the crazy Qualtrics title.
capping <- read.csv("capping_4_4.csv")
View(capping)
...
setwd("C:\\Users\\p00185232\\OneDrive - Houston Independent School District\\Documents\\capping tool\\Clean Files")
write.csv(capping, "capping_clean_4_4.csv")
...
### read in file. I had to rename the file after download, it wouldn't import
### with the crazy Qualtrics title.
capping <- read.csv("capping_3_8.csv")
View(capping)
### note here that first two rows of data are metadata from Qualtrics.
...
setwd("C:\\Users\\p00185232\\OneDrive - Houston Independent School District\\Documents\\capping tool\\Clean Files")
write.csv(capping, "capping_clean_3_8.csv")
...
### read in file. I had to rename the file after download, it wouldn't import
### with the crazy Qualtrics title.
capping <- read.csv("capping_9_26_4pm.csv")
View(capping)
### note here that first two rows of data are metadata from Qualtrics.
...
setwd("C:\\Users\\p00185232\\OneDrive - Houston Independent School District\\Documents\\capping tool\\Clean Files")
write.csv(capping, "capping_clean_9_26_4pm.csv")
